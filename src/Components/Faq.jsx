...
const Faq = () => {
  return (
    <div className="max-w-[1366px]  pb-5 mx-auto">
      <div className="w-[86.31%] mx-auto">
          ...
          <div className="questions">
            ...
            <div className="answer">
              <p className="bg-white w-[868px] px-[30px] py-6 rounded-b-md">
                ...
                iure quam nihil? At repellendus officiis perspiciatis incidunt
                eos tempore quis qui blanditiis vel culpa, ipsum ullam libero
